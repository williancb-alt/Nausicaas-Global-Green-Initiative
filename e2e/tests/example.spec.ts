...
test.describe("Authentication Flow", () => {
  test("should display login page", async ({ page }, testInfo) => {
    ...
    await takeScreenshot(
      page,
      testInfo,
      sequentialScreenshotNames("login-page-loaded"),
    )
  })
  ...
  test("should navigate to signup page", async ({ page }, testInfo) => {
    ...
    await takeScreenshot(
      page,
      testInfo,
      sequentialScreenshotNames("on-login-page"),
    )
    ...
    await takeScreenshot(
      page,
      testInfo,
      sequentialScreenshotNames("clicked-signup-link"),
    )
    ...
    await takeScreenshot(
      page,
      testInfo,
      sequentialScreenshotNames("on-signup-page"),
    )
    ...
    await takeScreenshot(
      page,
      testInfo,
      sequentialScreenshotNames("signup-form-visible"),
    )
  })
  ...
  test("should successfully sign up a new user", async ({ page }, testInfo) => {
    ...
    await takeScreenshot(
      page,
      testInfo,
      sequentialScreenshotNames("filled-email"),
    )
    ...
    await takeScreenshot(
      page,
      testInfo,
      sequentialScreenshotNames("clicked-signup-button"),
    )
    ...
    await takeScreenshot(
      page,
      testInfo,
      sequentialScreenshotNames("redirected-to-home"),
    )
  ...
  test("should show error for invalid login", async ({ page }, testInfo) => {
    ...
    await takeScreenshot(
      page,
      testInfo,
      sequentialScreenshotNames("login-page"),
    )
    ...
    await page.getByPlaceholder(/enter your password/i).fill("WrongPass1")
    await takeScreenshot(
      page,
      testInfo,
      sequentialScreenshotNames("filled-password"),
    ...
    await takeScreenshot(
      page,
      testInfo,
      sequentialScreenshotNames("clicked-login-button"),
    )
    ...
    await takeScreenshot(
      page,
      testInfo,
      sequentialScreenshotNames("error-message-shown"),
    )
  })
})
