...
describe("UserApplicationDetails", () => {
    ...
    it("should render application details with approved status", () => {
        render(<MemoryRouter><UserApplicationDetails application={mockApplication} onBack={onBackMock} /></MemoryRouter>)

        expect(screen.getAllByText("Green Energy Grant").length).toBeGreaterThanOrEqual(1)
    ...
    it("should show reviewer feedback if present", () => {
        ...
        render(<MemoryRouter><UserApplicationDetails application={appWithFeedback} onBack={onBackMock} /></MemoryRouter>)
    ...
    it("should handle different application statuses", () => {
        const pendingApp = { ...mockApplication, status: "pending_review" } as Application
        render(<MemoryRouter><UserApplicationDetails application={pendingApp} onBack={onBackMock} /></MemoryRouter>)
