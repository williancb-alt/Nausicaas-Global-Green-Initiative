...
export function UserApplicationResponses({
  ...
  if (!fieldValues || Object.keys(fieldValues).length === 0) {
    return (
      <div className="text-center py-4 text-muted border rounded" style={{ borderStyle: "dashed" }}>
        ...
        return (
          <div key={key} className="col-12">
            <div className="p-3 rounded-3" style={{ backgroundColor: "#f8fafc", border: "1px solid #e2e8f0" }}>
              <label className="text-muted small text-uppercase fw-bold mb-1 d-block" style={{ letterSpacing: "0.05em" }}>
                {label}
              </label>
