...
describe("LogoutButton", () => {
    ...
    it("should call logout mutation on click", () => {
        ...
        vi.mocked(useLogout).mockReturnValue({ mutate: mutateMock, isPending: false } as unknown as ReturnType<typeof useLogout>)
    ...
    it("should navigate to home on success", () => {
        const mutateMock = vi.fn((_?: void, options?: { onSuccess?: () => void }) => {
            options?.onSuccess?.()
        })
