...
describe("AdminDashboardApplicationsTable", () => {
    ...
    it("should show empty state", () => {
        render(<AdminDashboardApplicationsTable applications={[]} onViewApplication={onViewMock} />)
        expect(screen.getByText("No applications found")).toBeDefined()
    })

    it("should render table with applications", () => {
        render(<AdminDashboardApplicationsTable applications={mockApps} onViewApplication={onViewMock} />)
