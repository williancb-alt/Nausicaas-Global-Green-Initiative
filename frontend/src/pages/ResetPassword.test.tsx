...
describe("ResetPassword", () => {
    ...
    beforeEach(() => {
        vi.clearAllMocks()
        vi.mocked(useSearchParams).mockReturnValue([new URLSearchParams("token=test-token"), vi.fn()] as any)
    ...
    it("should render the reset password form when token is present", () => {
        ...
        expect(screen.getByRole("button", { name: BUTTON_TEXT.RESET_PASSWORD })).toBeDefined()
    })
