    ...
    <div style={{ backgroundColor: "#f0fdf4", minHeight: "100vh" }} className="py-4">
      <div className="container">
        <div className="d-flex justify-content-between align-items-center mb-4">
            <h1 className="h3 mb-0" style={{ color: "#2f6f44", fontWeight: "700" }}>All Applications</h1>
          <span className="badge" style={{ backgroundColor: "#3b7a57", color: "white", fontSize: "0.95rem" }}>{applications.length} total</span>
        </div>

        {applications.length === 0 ? (
            <div className="alert" style={{ backgroundColor: "#eef7ee", color: "#2f6f44", border: "1px solid #3b7a57" }}>
              ...
              {applications.map(app => {
                ...
                return (
                  <tr key={app.id}>
                    ...
                    <td>
                      <strong>${app.requestedAmount.toLocaleString()}</strong>
                    </td>
                    <td>
                    ...
                    <td>
                      <small>{new Date(app.submittedDate).toLocaleDateString()}</small>
                    </td>
                    <td>
                      <button
