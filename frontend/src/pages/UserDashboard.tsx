...
/**
 * Sub-component for the applications table to reduce UserDashboard complexity
 */
...
export function UserDashboard(): JSX.Element {
  ...
  const filteredApps = useMemo(() => {
    ...
    return applications.filter(a =>
      a.grant.name.toLowerCase().includes(term) ||
    ...
    <div className="container-fluid px-4 py-4 min-vh-100" style={{ backgroundColor: "#f8fafc" }}>
      ...
      <div className="row g-4 mb-5">
        <div className="col-12 col-md-6 col-lg-3">
          <StatCard title="Total" value={stats.total} icon={<LayoutDashboard size={24} />} color="#3b82f6" />
        </div>
        <div className="col-12 col-md-6 col-lg-3">
          <StatCard title="Approved" value={stats.approved} icon={<CheckCircle2 size={24} />} color="#10b981" />
        </div>
        <div className="col-12 col-md-6 col-lg-3">
          <StatCard title="In Review" value={stats.pending} icon={<Clock size={24} />} color="#f59e0b" />
        </div>
        <div className="col-12 col-md-6 col-lg-3">
          <StatCard title="Denied" value={stats.denied} icon={<AlertCircle size={24} />} color="#ef4444" />
        </div>
      </div>
      ...
      <div className="card border-0 shadow-sm" style={{ borderRadius: "12px" }}>
        ...
        <div className="card-body p-0">
          <ApplicationsTable applications={filteredApps} />
        </div>
