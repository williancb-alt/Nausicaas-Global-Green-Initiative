...
export function UserDashboard(): JSX.Element {
    ...
    return (
        <div style={{ backgroundColor: "#f0fdf4", minHeight: "100vh" }} className="pb-5">
            {/* Hero Section */}
            <div
                style={{
                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-md-8">
                            <h1 className="display-5 fw-bold mb-2">Welcome back, {user?.email?.split('@')[0]}!</h1>
                            <p className="lead opacity-75 mb-0">Track your sustainability grant applications and manage your impact.</p>
                        </div>
                        <div className="col-md-4 text-md-end mt-4 mt-md-0">
                            <button
                                onClick={handleApply}
                                className="btn btn-light btn-lg px-4 fw-bold"
                                style={{ color: "#3b7a57", borderRadius: "12px", transition: "transform 0.2s" }}
            ...
            <div className="container">
                ...
                <div className="card border-0 shadow-sm" style={{ borderRadius: "16px", overflow: "hidden" }}>
                    <div className="card-header bg-white py-3 border-bottom-0">
                        <h2 className="h4 mb-0 fw-bold" style={{ color: "#2d5a41" }}>Recent Activity</h2>
                    </div>
                    <div className="card-body p-0">
                        {isLoading ? (
                            ...
                            <div className="text-center py-5">
                                ...
                                <button onClick={handleApply} className="btn btn-outline-success">Browse Grants</button>
                            </div>
                        ) : (
                                ...
                                <table className="table table-hover align-middle mb-0">
                                    ...
                                    <tbody>
                                        {applications.map((app: Application) => (
                                            <tr key={app.id}>
                                                <td className="px-4 py-3 fw-semibold">{app.grant.name}</td>
                                                <td className="py-3 text-muted">{app.submitted_date}</td>
                                                <td className="py-3">
                                                    <span
                                                        className="badge"
                                                        style={{
