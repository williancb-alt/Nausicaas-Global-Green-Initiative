...
describe("useAwards", () => {
    ...
    it("should handle error", async () => {
        vi.mocked(api.awards.listAwards).mockRejectedValueOnce(new Error("API Error"))
...
describe("useAward", () => {
    ...
    it("should not fetch when name is empty", () => {
        const { result } = renderHook(() => useAward(""), { wrapper: createWrapper() })
...
describe("useDeleteAward", () => {
    ...
    it("should delete an award", async () => {
        ...
        const { result } = renderHook(() => useDeleteAward(), { wrapper: createWrapper() })
