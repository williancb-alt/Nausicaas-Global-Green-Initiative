...
describe("useMyApplications", () => {
    ...
    it("should handle error state", async () => {
        vi.mocked(api.applications.getMyApplications).mockRejectedValueOnce(new Error("Server error"))
...
describe("useDeleteApplication", () => {
    ...
    it("should delete application", async () => {
        vi.mocked(api.applications.deleteApplication).mockResolvedValueOnce(undefined)
