...
def create_grant(grant_dict):
    ...
    owner = User.find_by_public_id(create_grant.public_id)
...
@token_required
def retrieve_grant_list(page, per_page):
...
@admin_token_required
def update_grant(name, grant_dict):
