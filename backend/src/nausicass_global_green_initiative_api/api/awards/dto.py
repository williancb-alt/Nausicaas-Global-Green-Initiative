...
award_owner_model = Model("Award Owner", {"email": String, "public_id": String})
...
award_model = Model(
    "award",
    {
        ...
        "description": String,
        "owner": Nested(award_owner_model),
        "link": Url("api.award"),
    },
)
...
pagination_model = Model(
    "Pagination",
    {
        ...
        "items": List(Nested(award_model)),
    },
)

update_award_reqparser = create_award_reqparser.copy()
update_award_reqparser.remove_argument("name")
